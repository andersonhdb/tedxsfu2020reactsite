...
import Member from "../components/team-member2"
    ...
    <Layout>
      <div>
        ...
        <div class={teamStyle.project_leads}>
          ...
          <Member image={props.data.teamleadt1.childImageSharp.fixed} activeimage={props.data.teamleadt2.childImageSharp.fixed} name="Tony Virdo" job="Project lead"/>
          </div>
          <div onClick={()=>{setState({
            ...state,
          ...
          <Member image={props.data.teamleadm1.childImageSharp.fixed} activeimage={props.data.teamleadm2.childImageSharp.fixed} name="Meredith Nguyen" job="Project lead"/>
          </div>
...
query{
  ...
  teamleadm1: file(relativePath: {eq: "team/leads/m1_e.jpg"}) {
    childImageSharp{
      fixed(height: 200, width: 150){
        ...GatsbyImageSharpFixed
      }
  ...
  teamleadm2: file(relativePath: {eq: "team/leads/m2_e.jpg"}) {
    childImageSharp{
      fixed(height: 200, width: 150){
        ...GatsbyImageSharpFixed
      }
